...
internal static class RailGeometry
{
    ...
    public static double HeightFor(int itemCount)
    {
    ...
    public static double ListHeight(int itemCount) => Math.Max(0, itemCount) * ItemPitch;
    public static double GearTop(int itemCount) => EdgePad + EndControl + ListHeight(itemCount);
