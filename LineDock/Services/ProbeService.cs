...
internal sealed class ProbeService : IDisposable
{
    ...
    public ProbeService()
    {
        ...
        _http.DefaultRequestHeaders.TryAddWithoutValidation("User-Agent", "LineDock/0.1");
        _directHttp.DefaultRequestHeaders.TryAddWithoutValidation("User-Agent", "LineDock/0.1");
    ...
    private HttpClient ResolveHttp(ClientPresence client, out bool owns)
    {
        ...
        http.DefaultRequestHeaders.TryAddWithoutValidation("User-Agent", "LineDock/0.1");
        return http;
    }
