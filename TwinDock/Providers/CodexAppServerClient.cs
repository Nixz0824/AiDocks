...
internal sealed class CodexAppServerClient
{
    ...
    public async Task<IReadOnlyList<QuotaWindow>?> TryReadAsync(CancellationToken cancellationToken)
    {
        ...
        try
        {
            ...
            await process.StandardInput.WriteLineAsync("{\"id\":1,\"method\":\"initialize\",\"params\":{\"clientInfo\":{\"name\":\"quota-dock\",\"title\":\"TwinDock\",\"version\":\"0.3.0\"},\"capabilities\":{\"experimentalApi\":true}}}");
